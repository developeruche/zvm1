...
/// The address of the system contract processing builder deposits (EIP-8282, Amsterdam).
constexpr auto BUILDER_DEPOSIT_REQUEST_ADDRESS = 0x0000BFF46984E3725691FA540A8C7589300D8282_address;

/// The address of the system contract processing builder exits (EIP-8282, Amsterdam).
constexpr auto BUILDER_EXIT_REQUEST_ADDRESS = 0x000064D678505AD48F8CCB093BC65613800E8282_address;
